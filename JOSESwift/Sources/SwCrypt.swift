// Taken from https://github.com/soyersoyer/SwCrypt/blob/master/SwCrypt/SwCrypt.swift
// Ideally should be used as a POD, but wanted to forego the extra dependency for now
